...
const Register: React.FC = () => {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // If error says verification required, go to verify page
    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400">Join LOGify to manage your logs</p>
        </div>
        ...
        <div className="bg-slate-900/60 backdrop-blur-md border border-blue-500/20 rounded-lg p-8">
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full bg-black/40 border border-blue-500/20 rounded py-2 px-4 text-sm focus:outline-none focus:border-blue-500/50 transition-all"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 bg-blue-500 hover:bg-blue-600 rounded font-bold text-sm tracking-wider transition-all disabled:opacity-50"
            >
          ...
          <button
            ...
            className="w-full py-3 bg-white/10 hover:bg-white/20 border border-white/20 rounded font-bold text-sm tracking-wider transition-all flex items-center justify-center gap-2"
          >
